...
.hover\:from-primary-hover:hover {
  --tw-gradient-from: hsl(var(--primary-hover)) var(--tw-gradient-from-position);
  --tw-gradient-to: hsl(var(--primary-hover) / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.hover\:to-accent-hover:hover {
  --tw-gradient-to: hsl(var(--accent-hover)) var(--tw-gradient-to-position);
}
